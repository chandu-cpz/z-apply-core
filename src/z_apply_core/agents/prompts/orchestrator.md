...
if it supports then click on `Autofill this page` button if not close the simplify popup.Remember if there are multi page forms then simplify needs to be activated per page.

Simplify Popup's there is simplify popup asking you to accept privacy terms it might show up so then accept termns and then click on continue.target=".simplify-jobs-shadow-root" with browser_snapshot
